...
To generate all of the e-mails, run: `bash generate.sh`. The results are in a `YYYY-WW` directory for the current ISO week, with a subdirectory for each of the e-mails.
